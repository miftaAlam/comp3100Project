    ...
    public void findFirstCapable(){
        try{
           ...
           if(jobString[0].equals("JOBN")){
            ...
            jobEstruntime =  Integer.parseInt(jobString[5]);
            jobMemoryDisk = Integer.parseInt(jobString[6]);
            sendMessage("GETS Capable " + jobCore + " " + jobEstruntime + " " + jobMemoryDisk); //Send GETS Capable _ _ _
